    ...
    <section id="projects" className="bg-gray-100 pt-4 pb-12 px-4 w-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
        ...
        <div className="bg-white shadow-lg rounded-2xl overflow-hidden flex flex-col items-center p-6">
          <img src="/router.jpg" alt="Mikrotik" className="w-34 h-34 object-contain mb-4" />
        ...
        {/* Zkušenost 2 */}
        <div className="bg-white shadow-lg rounded-2xl overflow-hidden flex flex-col items-center p-6">
          <img src="/pc.jpg" alt="Hardware" className="w-34 h-34 object-contain mb-4" />
        ...
        {/* Zkušenost 3 */}
        <div className="bg-white shadow-lg rounded-2xl overflow-hidden flex flex-col items-center p-6">
          <img src="/work.jpg" alt="Mobilní elektronika" className="w-34 h-34 object-contain mb-4" />
